...
rem w32/build.bat - build script for W32 port
rem Copyright (C) 2004, 2005 Michael Riepe
rem
...
rem @(#) $Id: build.bat,v 1.5 2005/07/19 09:56:26 michael Exp $
...
cd ..\lib
nmake /nologo /f ..\w32\Makefile.w32 %1
cd ..\w32
