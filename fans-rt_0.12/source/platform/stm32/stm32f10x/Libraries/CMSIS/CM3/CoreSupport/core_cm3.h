 ...
 */
static __INLINE void NVIC_SetContextThisPriorityGrouping(uint32_t PriorityGroup)
{
  uint32_t reg_value;
 ...
 */
static __INLINE uint32_t NVIC_GetContextThisPriorityGrouping(void)
{
 ...
 */
static __INLINE void NVIC_SetContextThisPriority(IRQn_Type IRQn, uint32_t priority)
{
  if(IRQn < 0) {
 ...
 * Note: The priority cannot be set for every core interrupt.
 */
static __INLINE uint32_t NVIC_GetContextThisPriority(IRQn_Type IRQn)
{
 ...
 *
 * The returned priority value can be used for NVIC_SetContextThisPriority(...) function
 */
 ...
 * priority bits (__NVIC_PRIO_BITS) the samllest possible priority group is set.
 *
 * The priority value can be retrieved with NVIC_GetContextThisPriority(...) function
 */
...
{ 
  ...
  NVIC_SetContextThisPriority (SysTick_IRQn, (1<<__NVIC_PRIO_BITS) - 1);  /* set Priority for Cortex-M0 System Interrupts */
